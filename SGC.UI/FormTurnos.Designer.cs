...
partial class FormTurnos
{
    ...
    private void InitializeComponent()
    {
        ...
        ChkFiltrarFecha.Margin = new Padding(2);
        ...
        ChkFiltrarPaciente.Location = new Point(320, 124);
        ChkFiltrarPaciente.Margin = new Padding(2);
        ...
        ChkTodosMedicos.Margin = new Padding(2);
        ...
        BtnNuevoTurno.Location = new Point(344, 90);
        BtnNuevoTurno.Margin = new Padding(2);
        ...
        BtnModificar.Location = new Point(568, 90);
        ...
        ChkMostrarCancelados.Margin = new Padding(2);
        ...
        LblMensaje.Location = new Point(344, 124);
        ...
        BtnConfirmarAsistencia.Location = new Point(808, 90);
        BtnConfirmarAsistencia.Margin = new Padding(2);
        ...
        BtnAsignar.Location = new Point(456, 90);
        ...
        CboHorario.Location = new Point(176, 90);
        CboHorario.Margin = new Padding(2);
        ...
        DtpFecha.Location = new Point(16, 90);
        ...
        CboMedico.Location = new Point(240, 30);
        CboMedico.Margin = new Padding(2);
        ...
        CboPaciente.Location = new Point(16, 30);
        ...
        pnlAgenda.Margin = new Padding(2);
        ...
        DgvAgenda.Margin = new Padding(2);
        ...
        DgvAgenda.Size = new Size(224, 323);
        ...
        lblAgendaTitulo.Padding = new Padding(0, 0, 0, 6);
        lblAgendaTitulo.Size = new Size(128, 29);
